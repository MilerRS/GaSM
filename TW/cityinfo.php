...
<form action = "saveComment.php" method = "get">
	<label>Still not pleased? Write a small complaint: </label>
	<input type="text" name="comment">
	<input type ="hidden" name="neighbourhood" value= <?php echo $neighbourhood ?>>
	<input type="submit" value="Submit">
</form>

<div>Other residents have said...<br>
	<?php showComments($neighbourhood)?>
</div>
